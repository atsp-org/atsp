...
*     in this routine and in the subroutines in this program unit)
      ...
      PARAMETER (NOD=220,NWD=30,NCD=500,NORD=NWD*(NWD-1)/2)
...
*                        Common blocks
      ...
      COMMON/TENSR/VVSHELL(50),IIHSH,NNOVLP(50),IIRHO(50),IISIG(50),
...
*
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      PARAMETER(NOD=220,NWD=30,NCD=500)
      INTEGER SMAX(NWD)
...
*     Tensorial Sets.
      ...
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      PARAMETER(NOD=220,NWD=30,NCD=500,EPSILO=1.D-9)
      COMMON/TENSR/VVSHELL(50),IIHSH,NNOVLP(50),IIRHO(50),IISIG(50),
     : MMU(50),MMUP(50),NNU(50),NNUP(50)
      COMMON/HYPER/NHY,MHY,IRHY(20),ISHY(20),JRHY(20),JSHY(20),VHY(20),
     1 IMUHY(20),IMUPHY(20),JMUHY(20),JMUPHY(20),
...
*
      ...
      DOUBLE PRECISION FUNCTION QUADR2(I,J,KK)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      PARAMETER(NOD=220,NWD=30,NCD=500)
      COMMON /PARAT/D0,D1,D2,D3,D4,D5,D6,D10,H,H1,NO,ND
      COMMON/ADATA/MNCFG,MNNN,P(NOD,NWD),R(NOD),RR(NOD),R2(NOD),
...
*
     ...
     2 INUHY(20),INUPHY(20),JNUHY(20),JNUPHY(20),NNNOVLP(20)
      ...
      RADINT= QUADR2(IRHY(N),ISHY(N),-3)
      IF (NNNOVLP(N).EQ.1) THEN
         OVLINT1=(QUADR2(IMUHY(N),IMUPHY(N),0))**(IOVEP(1))
         RADINT=RADINT*OVLINT1
      ELSEIF (NNNOVLP(N).GT.1) THEN
         OVLINT1=(QUADR2(IMUHY(N),IMUPHY(N),0))**(IOVEP(1))
         OVLINT2=(QUADR2(INUHY(N),INUPHY(N),0))**(IOVEP(1))
...
* 
     ...
     2 INUHY(20),INUPHY(20),JNUHY(20),JNUPHY(20),NNNOVLP(20)
      ...
      ELSEIF (NNNOVLP(N).GT.1) THEN
         OVLINT1=(QUADR2(IMUHY(N),IMUPHY(N),0))**(IOVEP(1))
         OVLINT2=(QUADR2(INUHY(N),INUPHY(N),0))**(IOVEP(2))
